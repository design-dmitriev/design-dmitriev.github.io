...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const GLYPH_MAPS = {
        ...
        // версии. data-glyph и data-icon3d держат один и тот же смысл, но
        // имена ключей не всегда совпадают — некоторые пиксельные версии
        // сознательно переехали на более простой силуэт (см. crt/monitor/star
        // ниже), десктопная 3D-модель при этом не менялась.
        //
        // chip сейчас не используется ни в одной карточке (No.001 отдан
        // старому CRT-монитору), но оставлен в библиотеке — как и другие
        // отклонённые варианты в case-icon-models.js, вдруг ещё пригодится.
        chip: [
            '................',
            '................',
            '.....#.#.#......',
        ...
        // Старый ЭЛТ-монитор для No.001 — толще и квадратнее плоского
        // monitor ниже (у него утопленный экран-рамка внутри корпуса),
        // чтобы две карточки-«монитора» рядом не читались как одно и то же.
        crt: [
            '................',
            '................',
            '..############..',
        ...
        // Монитор — мобильный фолбэк для No.002 (была монетка, читалась как
        // невнятное пятно). Десктопная 3D-модель осталась спутниковой
        // тарелкой (case-icon-models.js, key "radar") — здесь сознательно
        // другой, более простой силуэт: рамка экрана + шея + подставка,
        // без внутренней «начинки», чтобы не рассыпаться в кашу на 16×16.
        monitor: [
            '................',
            '................',
            '................',
        ...
        // Планета с кольцом — раньше был просто шар с экватором, который на
        // взгляд не отличался от монетки-диска, потом стала кольцом со сферой —
        // тоже не зашло: круглые формы на сетке 16×16 читаются нечётко. Заменена
        // на звезду/искру — прямой крест с диагональными засечками по углам,
        // без единой кривой линии, поэтому и без каши, характерной для кругов.
        star: [
            '................',
            '................',
            '.......##.......',
